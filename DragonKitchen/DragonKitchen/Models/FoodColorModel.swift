...
class CarrotColor {
    ...
    var brown = (Color(hex: 0x00AE26), Color(hex: 0xC9751C), Color(hex: 0x914517), Color(hex: 0x000000))
    var yellow = (Color(hex: 0x00AE26), Color(hex: 0xC9751C), Color(hex: 0xF6DA00), Color(hex: 0x000000))
    var green = (Color(hex: 0x00AE26), Color(hex: 0xC9751C), Color(hex: 0x41AF39), Color(hex: 0x000000))
    var burgundy = (Color(hex: 0x00AE26), Color(hex: 0xC9751C), Color(hex: 0x960A00), Color(hex: 0x000000))
...
class PaprikaColor {
    var red = (Color(hex: 0x5D651B), Color(hex: 0x8C9B00), Color(hex: 0x8C9B00), Color(hex: 0xB62626), Color(hex: 0x000000))
