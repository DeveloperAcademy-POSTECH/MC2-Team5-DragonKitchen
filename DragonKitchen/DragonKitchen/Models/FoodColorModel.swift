...
class CarrotColor {
    ...
    var brown = (Color(hex: 0x00AE26), Color(hex: 0x54260B), Color(hex: 0x753E1E), Color(hex: 0x000000))
    var yellow = (Color(hex: 0x00AE26), Color(hex: 0xCAB302), Color(hex: 0xF6DA00), Color(hex: 0x000000))
    var green = (Color(hex: 0x00AE26), Color(hex: 0x14600F), Color(hex: 0x41AF39), Color(hex: 0x000000))
